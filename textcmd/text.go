...
func Commands(command string) *string {
	...
	case "!verify", "!verified":
		...
		message += "\n"
		message += "You can request to be Verified in the #general channel. This allows us to see who is a community member and gives you extra privileges such as Voice chat and access to more channels.\n\n"
		message += "To get Verified:\n"
		message += "a) Mention you would like to be Verified in the #general channel. Mentioning where you came from and how you found out about Ubiq helps too.\n"
