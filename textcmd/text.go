...
func Commands(command string) *string {
	...
	case "!exchange", "!market":
		message = "`Bittrex:` <https://bittrex.com/Market/Index?MarketName=BTC-UBQ> `CryptoBridge:` <https://wallet.crypto-bridge.org/market/BRIDGE.UBQ_BRIDGE.BTC> `Litebit:` <https://www.litebit.eu/en/buy/ubiq> `UPBit:` <https://upbit.com/exchange?code=CRIX.UPBIT.BTC-UBQ> `TradeCX:` <https://tradecx.io/markets/ubqbtc>\n"
	case "!explorer":
