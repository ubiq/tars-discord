...
func Commands(command string) *string {
	...
	case "!miner":
		message = "`Ubqminer:` <https://github.com/ubiq/ubqminer/releases> `PhoenixMiner 4.0b+:` <https://bitcointalk.org/index.php?topic=2647654.0> `TT-Miner:` <https://bitcointalk.org/index.php?topic=5025783.0> `Nanominer:` <https://nanominer.org/>\n"
