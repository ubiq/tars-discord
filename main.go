...
func handleMessage(s *discordgo.Session, m *discordgo.MessageCreate) *string {
	...
	case "!ann", "!apx", "!backup", "!blank", "!bots", "!caps", "!commands", "!compare", "!escher", "!escrow", "!ethunits", "!exchange", "!explorer", "!github", "!hide", "!hidechannels", "!invite", "!market", "!miner", "!mp", "!monetarypolicy", "!nucleus", "!onepage", "!pools", "!quarterly", "!resettabs", "!roadmap", "!site", "!social", "!solidity", "!stats", "!transparency", "!verified", "!verify", "!wallet", "!website", "!shokku", "!vyper":
